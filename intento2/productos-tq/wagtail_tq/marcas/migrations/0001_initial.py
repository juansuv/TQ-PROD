    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categories', modelcluster.fields.ParentalManyToManyField(blank=True, to='marcas.MarcasCategory')),
        ...
        migrations.AddField(
            model_name='postpage',
            name='tags',
            field=modelcluster.contrib.taggit.ClusterTaggableManager(blank=True, help_text='A comma-separated list of tags.', through='marcas.MarcasPageTag', to='taggit.Tag', verbose_name='Tags'),
        ),
        migrations.AddField(
            model_name='marcaspagetag',
            name='content_object',
            field=modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='post_tags', to='marcas.PostPage'),
        ),
        migrations.AddField(
            model_name='marcaspagetag',
            name='tag',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='marcas_marcaspagetag_items', to='taggit.Tag'),
        ),
    ]
